...
namespace MiKoSolutions.Analyzers.Rules.Documentation
{
    ...
    public sealed class MiKo_2030_ReturnTypeDefaultPhraseAnalyzer : ReturnsValueDocumentationAnalyzer
    {
        ...
        protected override IEnumerable<Diagnostic> AnalyzeReturnType(ISymbol owningSymbol, ITypeSymbol returnType, XmlElementSyntax comment, string xmlTag) => AnalyzeStartingPhrase(owningSymbol, comment, xmlTag, Constants.Comments.ReturnTypeStartingPhrase);
    }
}