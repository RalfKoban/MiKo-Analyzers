...
namespace MiKoSolutions.Analyzers.Rules.Documentation
{
    ...
    public sealed class MiKo_2004_EventHandlerParametersAnalyzer : DocumentationAnalyzer
    {
        ...
        {
            var inheritDoc = comment.FirstDescendant<XmlEmptyElementSyntax>(_ => _.GetName() == Constants.XmlTag.Inheritdoc);
            if (inheritDoc is null)
            {
                // TODO: RKN Fix parameter checks
                return VerifyParameterComments(symbol, comment.ToFullString());
            }
