...
namespace MiKoSolutions.Analyzers.Rules.Documentation
{
    ...
    public sealed class MiKo_2047_ValueConverterSummaryDefaultPhraseAnalyzer : SummaryDocumentationAnalyzer
    {
        ...
        public MiKo_2047_ValueConverterSummaryDefaultPhraseAnalyzer() : base(Id, SymbolKind.NamedType)
        {
        }
