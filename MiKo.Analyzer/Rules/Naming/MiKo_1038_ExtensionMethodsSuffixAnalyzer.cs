...
namespace MiKoSolutions.Analyzers.Rules.Naming
{
    ...
    public sealed class MiKo_1038_ExtensionMethodsSuffixAnalyzer : NamingAnalyzer
    {
        public const string Id = "MiKo_1038";

        private const string Suffix = "Extensions";

        public MiKo_1038_ExtensionMethodsSuffixAnalyzer() : base(Id, SymbolKind.NamedType)
        {
        }
