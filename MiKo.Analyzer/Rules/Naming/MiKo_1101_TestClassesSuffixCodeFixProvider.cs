...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MiKo_1101_TestClassesSuffixCodeFixProvider)), Shared]
    public sealed class MiKo_1101_TestClassesSuffixCodeFixProvider : NamingCodeFixProvider
    {
