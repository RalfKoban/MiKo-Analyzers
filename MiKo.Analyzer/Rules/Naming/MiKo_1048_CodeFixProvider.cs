...
namespace MiKoSolutions.Analyzers.Rules.Naming
{
    ...
    public sealed class MiKo_1048_CodeFixProvider : NamingCodeFixProvider
    {
        ...
        protected override CodeAction CreateCodeAction(Document document, IEnumerable<SyntaxNode> syntaxNodes)
        {
            ...
            const string Title = "Append '" + MiKo_1048_ValueConverterSuffixAnalyzer.Suffix + "' to type name";
                                                            ...
                                                            (semanticModel, token) =>
                                                                {
                                                                    ...
                                                                    var newName = MiKo_1048_ValueConverterSuffixAnalyzer.FindBetterName(symbol);
