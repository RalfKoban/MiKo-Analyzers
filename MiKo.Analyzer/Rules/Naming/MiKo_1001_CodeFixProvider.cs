...
namespace MiKoSolutions.Analyzers.Rules.Naming
{
    ...
    public sealed class MiKo_1001_CodeFixProvider : NamingCodeFixProvider
    {
        ...
        protected override string GetNewName(ISymbol symbol) => MiKo_1001_EventArgsParameterAnalyzer.FindBetterName((IParameterSymbol)symbol);
