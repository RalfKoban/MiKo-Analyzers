...
namespace MiKoSolutions.Analyzers.Rules.Maintainability
{
    ...
    public sealed class MiKo_3020_CodeFixProvider : MaintainabilityCodeFixProvider
    {
        ...
        protected override SyntaxNode GetUpdatedSyntax(Document document, SyntaxNode syntax) => CreateSimpleMemberAccessExpressionSyntax(nameof(Task), nameof(Task.CompletedTask));
    }
}