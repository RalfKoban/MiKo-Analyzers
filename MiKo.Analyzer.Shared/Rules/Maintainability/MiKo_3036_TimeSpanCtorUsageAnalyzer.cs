...
namespace MiKoSolutions.Analyzers.Rules.Maintainability
{
    ...
    public sealed class MiKo_3036_TimeSpanCtorUsageAnalyzer : ObjectCreationExpressionMaintainabilityAnalyzer
    {
        ...
        protected override bool ShallAnalyzeObjectCreation(ObjectCreationExpressionSyntax node, SemanticModel semanticModel) => node.Type.ToString() is nameof(TimeSpan);
