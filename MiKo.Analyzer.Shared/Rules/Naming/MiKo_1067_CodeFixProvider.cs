...
namespace MiKoSolutions.Analyzers.Rules.Naming
{
    ...
    {
        public override string FixableDiagnosticId => "MiKo_1067";

        protected override string Title => Resources.MiKo_1067_CodeFixTitle;

        protected override string GetNewName(Diagnostic diagnostic, ISymbol symbol) => MiKo_1067_PerformMethodsAnalyzer.FindBetterName((IMethodSymbol)symbol);
