...
namespace MiKoSolutions.Analyzers.Rules.Naming
{
    ...
    {
        public override string FixableDiagnosticId => "MiKo_1032";

        protected override string Title => Resources.MiKo_1032_CodeFixTitle;

        protected override string GetNewName(Diagnostic diagnostic, ISymbol symbol) => MiKo_1032_MethodModelSuffixAnalyzer.FindBetterName((IMethodSymbol)symbol);
