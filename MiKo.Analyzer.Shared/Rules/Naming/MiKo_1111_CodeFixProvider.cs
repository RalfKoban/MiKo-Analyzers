...
namespace MiKoSolutions.Analyzers.Rules.Naming
{
    ...
    {
        public override string FixableDiagnosticId => MiKo_1111_TestMethodsShouldNotBeNamedScenarioExpectedOutcomeAnalyzer.Id;

        protected override string Title => Resources.MiKo_1111_CodeFixTitle;

        protected override string GetNewName(Diagnostic diagnostic, ISymbol symbol) => MiKo_1111_TestMethodsShouldNotBeNamedScenarioExpectedOutcomeAnalyzer.FindBetterName(symbol);
