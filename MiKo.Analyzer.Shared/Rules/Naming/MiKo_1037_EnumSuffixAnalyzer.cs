...
namespace MiKoSolutions.Analyzers.Rules.Naming
{
    ...
    public sealed class MiKo_1037_EnumSuffixAnalyzer : NamingAnalyzer
    {
        ...
        protected override bool ShallAnalyze(ITypeSymbol symbol) => symbol.Name.EndsWithAny(WrongNames); // not only for enums, but also for other types (hence we do not use 'symbol.EnumUnderlyingType' nor 'symbol.IsEnum' here)
