...
namespace MiKoSolutions.Analyzers.Rules.Spacing
{
    ...
    {
        public override string FixableDiagnosticId => MiKo_6046_CalculationOperationsAreOnSameLineAnalyzer.Id;

        protected override string Title => Resources.MiKo_6046_CodeFixTitle;
