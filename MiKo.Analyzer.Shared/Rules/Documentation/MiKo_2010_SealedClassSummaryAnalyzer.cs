...
namespace MiKoSolutions.Analyzers.Rules.Documentation
{
    ...
    public sealed class MiKo_2010_SealedClassSummaryAnalyzer : SummaryDocumentationAnalyzer
    {
        ...
        protected override bool ShallAnalyze(ISymbol symbol) => symbol is INamedTypeSymbol type && type.TypeKind is TypeKind.Class && type.DeclaredAccessibility is Accessibility.Public && type.IsTestClass() is false;
