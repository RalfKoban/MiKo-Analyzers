...
namespace MiKoSolutions.Analyzers.Rules.Documentation
{
    ...
    public sealed class MiKo_2231_InheritdocGetHashCodeAnalyzer : DocumentationAnalyzer
    {
        ...
        protected override bool ShallAnalyze(ISymbol symbol) => symbol is IMethodSymbol method && method.IsOverride && method.Parameters.IsEmpty && method.ReturnType.SpecialType is SpecialType.System_Int32 && method.Name is nameof(GetHashCode);
