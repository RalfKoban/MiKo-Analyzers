            ...
            internal static readonly string[] MeaninglessPhrase =
                                                                  {
                                                                      ...
                                                                      // boolean properties made worse by StyleCop fix
                                                                      "whether specify whether",
                                                                      "whether specifies whether",
                                                                      "whether describe whether",
                                                                      "whether describes whether",
                                                                      "whether specify if",
                                                                      "whether specifies if",
                                                                      "whether describe if",
                                                                      "whether describes if",
                                                                      "whether specify that",
                                                                      "whether specifies that",
                                                                      "whether describe that",
                                                                      "whether describes that",
                                                                      "indicating whether a value indicating",
                                                                      "indicating whether a bool indicating",
                                                                      "indicating whether a boolean indicating",
                                                                      "indicating whether the value indicating",
                                                                      "indicating whether the bool indicating",
                                                                      "indicating whether the boolean indicating",
                                                                      "indicating whether value indicating",
                                                                      "indicating whether bool indicating",
                                                                      "indicating whether boolean indicating",
                                                                      "indicating whether indicat",
                                                                      "Value indicating whether",
                                                                      "Value indicating if",
                                                                      "Value that indicates whether",
                                                                      "Value that indicates if",
                                                                      "Value which indicates whether",
                                                                      "Value which indicates if",
                                                                  };
            ...
            internal static readonly string[] TypedCollectionReturnTypeStartingPhrases =
                                                                                         {
                                                                                             ...
                                                                                             "A <see cref=\"{0}\"/> of <see cref=\"{1}\"/> that contains ",
                                                                                             "A <see cref=\"{0}\"/> of <see cref=\"{1}\" /> that contains ",
                                                                                             "A <see cref=\"{0}\" /> that contains ",
                                                                                             "A <see cref=\"{0}\" /> of <see cref=\"{1}\"/> that contains ",
                                                                                             "A <see cref=\"{0}\" /> of <see cref=\"{1}\" /> that contains ",
                                                                                             "A <see cref=\"{0}\"/> containing ",
                                                                                             "A <see cref=\"{0}\"/> of <see cref=\"{1}\"/> containing ",
                                                                                             "A <see cref=\"{0}\"/> of <see cref=\"{1}\" /> containing ",
                                                                                             "A <see cref=\"{0}\" /> containing ",
                                                                                             "A <see cref=\"{0}\" /> of <see cref=\"{1}\"/> containing ",
                                                                                             "A <see cref=\"{0}\" /> of <see cref=\"{1}\" /> containing ",
                                                                                             ...
                                                                                             "An <see cref=\"{0}\"/> of <see cref=\"{1}\" /> that contains ",
                                                                                             "An <see cref=\"{0}\"/> of <see cref=\"{1}\"/> that contains ",
                                                                                             "An <see cref=\"{0}\" /> that contains ",
                                                                                             "An <see cref=\"{0}\" /> of <see cref=\"{1}\"/> that contains ",
                                                                                             "An <see cref=\"{0}\" /> of <see cref=\"{1}\" /> that contains ",
                                                                                             "An <see cref=\"{0}\"/> containing ",
                                                                                             "An <see cref=\"{0}\"/> of <see cref=\"{1}\"/> containing ",
                                                                                             "An <see cref=\"{0}\"/> of <see cref=\"{1}\" /> containing ",
                                                                                             "An <see cref=\"{0}\" /> containing ",
                                                                                             "An <see cref=\"{0}\" /> of <see cref=\"{1}\"/> containing ",
                                                                                             "An <see cref=\"{0}\" /> of <see cref=\"{1}\" /> containing ",
