        ...
        private static readonly Pair[] Prefixes =
                                                  {
                                                      ...
                                                      new Pair("bckgnd", "background"),
                                                      new Pair("bckgrnd", "background"),
                                                      new Pair("bk", "back"),
                                                      new Pair("bmp", "bitmap"),
                                                      new Pair("btn", "button"),
                                                      ...
                                                      new Pair("neg", "negative"),
                                                      new Pair("nfy", "notificationIcon"),
                                                      new Pair("num", "number"),
        ...
        private static readonly Pair[] Cleanups =
                                                  {
                                                      ...
                                                      new Pair("orizontalon", "orizon"), // 'horiz' within 'horizon' / 'horizontal'
