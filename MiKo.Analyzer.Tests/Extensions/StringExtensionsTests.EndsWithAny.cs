...
namespace MiKoSolutions.Analyzers.Extensions
{
    ...
    public static partial class StringExtensionsTests
    {
        ...
        [Test]
        public static void EndsWithAny_with_collection_expression_returns_false_for_null_value() => Assert.That(((string)null).EndsWithAny(new[] { "bc" }), Is.False);

        [Test]
        public static void EndsWithAny_with_collection_expression_returns_false_for_empty_value() => Assert.That(string.Empty.EndsWithAny(new[] { "bc" }), Is.False);
        ...
        [Test]
        public static void EndsWithAny_with_collection_expression_returns_false_when_no_suffix_matches() => Assert.That("abc".EndsWithAny(new[] { "xy", "de" }), Is.False);

        [Test]
        public static void EndsWithAny_with_collection_expression_returns_false_when_suffix_is_longer_than_value() => Assert.That("ab".EndsWithAny(new[] { "abc" }), Is.False);

        [Test]
        public static void EndsWithAny_with_collection_expression_returns_true_when_first_suffix_matches() => Assert.That("abc".EndsWithAny(new[] { "bc", "xy" }), Is.True);

        [Test]
        public static void EndsWithAny_with_collection_expression_returns_true_when_last_suffix_matches() => Assert.That("abc".EndsWithAny(new[] { "xy", "bc" }), Is.True);

        [Test]
        public static void EndsWithAny_with_collection_expression_returns_true_when_value_equals_suffix() => Assert.That("abc".EndsWithAny(new[] { "abc" }), Is.True);

        [Test]
        public static void EndsWithAny_with_collection_expression_returns_false_for_different_casing_with_ordinal_comparison() => Assert.That("abc".EndsWithAny(new[] { "BC" }), Is.False);

        [Test]
        public static void EndsWithAny_with_collection_expression_returns_true_for_different_casing_with_OrdinalIgnoreCase_comparison() => Assert.That("abc".EndsWithAny(new[] { "BC" }, StringComparison.OrdinalIgnoreCase), Is.True);
