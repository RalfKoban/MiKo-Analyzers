...
");
        ...
        [TestCase("Call-Backs to notify about", "Encapsulates a method that notifies about")]
        [TestCase("Declare a delegate for create", "Encapsulates a method that creates")]
        [TestCase("Declares a delegate for create", "Encapsulates a method that creates")]
        [TestCase("Declare the delegate for create", "Encapsulates a method that creates")]
        [TestCase("Declares the delegate for create", "Encapsulates a method that creates")]
        [TestCase("Declare a delegate type for create", "Encapsulates a method that creates")]
        [TestCase("Declares a delegate type for create", "Encapsulates a method that creates")]
        [TestCase("Declare the delegate type for create", "Encapsulates a method that creates")]
        [TestCase("Declares the delegate type for create", "Encapsulates a method that creates")]
        [TestCase("Declare a delegate signature for create", "Encapsulates a method that creates")]
        [TestCase("Declares a delegate signature for create", "Encapsulates a method that creates")]
        [TestCase("Declare the delegate signature for create", "Encapsulates a method that creates")]
        [TestCase("Declares the delegate signature for create", "Encapsulates a method that creates")]
        ...
        [TestCase("""Represents the signature for the <see cref="Whatever"/> method""", """Encapsulates a method that has the same signature as the <see cref="Whatever"/> method""")]
