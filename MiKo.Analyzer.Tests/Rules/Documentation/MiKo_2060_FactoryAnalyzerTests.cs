...
";
        ...
        [TestCase("The class containing factory methods for constructing", "Provides support for creating")]
        [TestCase("The class containing methods for constructing", "Provides support for creating")]
        [TestCase("Class containing factory methods for constructing", "Provides support for creating")]
        [TestCase("Class containing methods for constructing", "Provides support for creating")]
        public void Code_gets_fixed_for_class_summary_(string originalSummary, string fixedSummary)
        {
...
";
            ...
            VerifyCSharpFix(Template.Replace("###", originalSummary), Template.Replace("###", fixedSummary));
        }
        ...
        private static HashSet<string> CreateTypeSummaryStartingPhrases()
        {
            string[] phrases =
                               [
                                   ...
                                   "A interface of a factory for creating",
                                   "A interface of a factory that creates",
                                   "A interface of a factory to create",
                                   "A interface of a factory which creates",
                                   ...
                                   "An interface of a factory for creating",
                                   "An interface of a factory that creates",
                                   "An interface of a factory to create",
                                   "An interface of a factory which creates",
                                   ...
                                   "Class for creating",
                                   "Class for creation of",
                                   "Class for providing",
                                   "Class for the creation of",
                                   "Class for factory methods to create",
                                   "Class for methods to create",
                                   "Class for",
                                   "Class that can create",
                                   "Class that provides methods to create",
                                   "Class that provides",
                                   "Class to create",
                                   "Class to provide methods to create",
                                   "Class to provide",
                                   "Class which can create",
                                   "Class which provides methods to create",
                                   ...
                                   "Interface of a factory for creating",
                                   "Interface of a factory that creates",
                                   "Interface of a factory to create",
                                   "Interface of a factory which creates",
                                   ...
                                   "The interface of a factory for creating",
                                   "The interface of a factory that creates",
                                   "The interface of a factory to create",
                                   "The interface of a factory which creates",
            ...
            var startingPhrases = phrases.Concat(phrases.Select(_ => _.Replace("actory", "actory class"))).ToList();
            ...
            foreach (var startingPhrase in startingPhrases.Concat(constructionPhrases).Concat(buildingPhrases))
            {
