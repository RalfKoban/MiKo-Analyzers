...
";
        ...
        [TestCase("""Returns <see langref="true"/> only if""")]
        [TestCase("""Returns <see langref="true"/> only whether""")]
        [TestCase("""Returns <see langref="true"/> whether""")]
        [TestCase("""Returns <see langword="true"/> if""")]
        [TestCase("""Returns <see langword="true"/> only if""")]
        [TestCase("""Returns <see langword="true"/> only whether""")]
        [TestCase("""Returns <see langword="true"/> whether""")]
        [TestCase("Return")]
        [TestCase("Returns true if")]
        [TestCase("Returns true only if")]
        [TestCase("Returns")]
...
";
        ...
        [TestCase("Returns <b>true</b> only if")]
        [TestCase("Returns <c>true</c> if")]
        [TestCase("Returns <c>true</c> only if")]
        [TestCase("Returns <value>true</value> if")]
        [TestCase("Returns <value>true</value> only if")]
        [TestCase("Returns true if")]
        [TestCase("Returns true only if")]
        [TestCase("Returns true only whether")]
...
";
        ...
        [TestCase("""Asynchronously returns <see langref="true"/> only if""")]
        [TestCase("""Asynchronously returns <see langref="true"/> only whether""")]
        [TestCase("""Asynchronously returns <see langref="true"/> whether""")]
        [TestCase("""Asynchronously returns <see langword="true"/> if""")]
        [TestCase("""Asynchronously returns <see langword="true"/> only if""")]
        [TestCase("""Asynchronously returns <see langword="true"/> only whether""")]
        ...
        [TestCase("""Returns <see langword="true"/> only whether""")]
        [TestCase("""Returns <see langword="true"/> whether""")]
        [TestCase("Asynchronously returns <b>true</b> only whether")]
        [TestCase("Asynchronously returns <b>true</b> whether")]
        [TestCase("Asynchronously returns <c>true</c> only whether")]
        [TestCase("Asynchronously returns <c>true</c> whether")]
        [TestCase("Asynchronously returns <value>true</value> only whether")]
        [TestCase("Asynchronously returns <value>true</value> whether")]
        [TestCase("Asynchronously returns true if")]
        [TestCase("Asynchronously returns true only if")]
        [TestCase("Asynchronously returns true only whether")]
