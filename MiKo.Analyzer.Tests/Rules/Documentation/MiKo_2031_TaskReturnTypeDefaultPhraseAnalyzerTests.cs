...
";
        ...
        [TestCase(@"A <see cref=""Task""/> that represents the asynchronous operation.", "TODO")]
        [TestCase(@"A <see cref=""Task""/> that represents the operation.", "TODO")]
        ...
        [TestCase("A task that represents the asynchronous operation.", "TODO")]
        [TestCase("A task that represents the operation.", "TODO")]
        ...
        [TestCase(@"A Task that can be used to await. The new <see cref=""string"" />.", @"the new <see cref=""string"" />.")]
        [TestCase("A task that can be used to await.", "TODO")]
        [TestCase("A task that can be used to await", "TODO")]
        ...
        [TestCase(@"An awaitable Task and the new <see cref=""string"" />.", @"the new <see cref=""string"" />.")]
        [TestCase(@"An awaitable Task. The new <see cref=""string"" />.", @"the new <see cref=""string"" />.")]
        [TestCase("An awaitable task.", "TODO")]
        [TestCase("An awaitable task", "TODO")]
        [TestCase("An awaitable Task.", "TODO")]
        [TestCase("An awaitable Task", "TODO")]
        [TestCase("A task that represents the operation. The Result is a project.", "a project.")]
        [TestCase("A task that represents the asynchronous operation. The Result is a project.", "a project.")]
        [TestCase("An task that represents the operation. The Result is a project.", "a project.")]
        [TestCase("An task that represents the asynchronous operation. The Result is a project.", "a project.")]
        [TestCase("Returns a task that represents the operation. The Result is a project.", "a project.")]
        [TestCase("Returns an task that represents the operation. The Result is a project.", "a project.")]
        [TestCase("Returns a task that represents the asynchronous operation. The Result is a project.", "a project.")]
        [TestCase("Returns an task that represents the asynchronous operation. The Result is a project.", "a project.")]
        [TestCase(@"A task that represents the asynchronous operation where the task result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation where the Task result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation where the Task Result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation where the task's result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation where the task's Result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation where the Task's result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation where the Task's Result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation, the task result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation, the Task result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation, the Task Result contains the project.", @"the project.")]
        ...
        [TestCase(@"A task that represents the asynchronous operation, the Task's result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation, the Task's Result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation. The task result contains a project.", @"a project.")]
        [TestCase(@"A task that represents the asynchronous operation. The task result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation. The Task result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation. The Task Result contains the project.", @"the project.")]
        [TestCase(@"A task that represents the asynchronous operation. The task's result contains the project.", @"the project.")]
