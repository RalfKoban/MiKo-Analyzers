...
");
        ...
        [TestCase("A helper command that's able to do something", "do something")]
        ...
        [TestCase("An helper command that's able to do something", "do something")]
        ...
        [TestCase("Helper command that's able to do something", "do something")]
        ...
        [TestCase("Represents a command that's capable to open", "open")]
        ...
        [TestCase("The helper command that's able to do something", "do something")]
        ...
        [TestCase("This command must be used to execute", "execute")]
