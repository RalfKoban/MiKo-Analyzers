...
";
        ...
        [TestCase("<b>true</b> when something. Otherwise <b>false</b>.")]
        [TestCase("<c>true</c> if something. Otherwise <c>false</c>.")]
        [TestCase("<c>true</c> if something; otherwise, <c>false</c>.")]
        [TestCase("<c>true</c> when something. Otherwise <c>false</c>.")]
        [TestCase("<c>true</c> when something; otherwise, <c>false</c>.")]
        [TestCase("<code>true</code> if something; otherwise, <code>false</code>.")]
        [TestCase("<code>true</code> when something; otherwise, <code>false</code>.")]
        [TestCase("Returns True if something, otherwise returns False.")]
        [TestCase("Returns True if something, returns otherwise False.")]
        [TestCase("Returns True when something, otherwise returns False.")]
        [TestCase("Returns True when something, returns otherwise False.")]
        [TestCase("TRUE if something, otherwise returns FALSE.")]
        [TestCase("TRUE when something, otherwise returns FALSE.")]
        [TestCase("TRUE, if something, otherwise returns FALSE.")]
        [TestCase("TRUE, when something, otherwise returns FALSE.")]
        [TestCase("TRUE: if something, otherwise returns FALSE.")]
        [TestCase("TRUE: when something, otherwise returns FALSE.")]
        ...
        [TestCase("True if something, otherwise returns False.")]
        [TestCase("True if something. False otherwise.")]
        [TestCase("True when something, False otherwise.")]
        [TestCase("True when something, otherwise False.")]
        [TestCase("True when something, otherwise returns False.")]
        [TestCase("True when something. False otherwise.")]
        [TestCase("True, if something")]
        [TestCase("True, when something")]
        [TestCase("true if something, else with false.")]
        [TestCase("true if something, false otherwise.")]
        [TestCase("true if something. Otherwise false.")]
        [TestCase("true when something else false")]
        [TestCase("true when something else false.")]
        [TestCase("true when something, else with false.")]
        [TestCase("true when something, false otherwise.")]
        [TestCase("true when something. Otherwise false.")]
        [TestCase("true, if something, else it returns false.")]
        [TestCase("true, if something, false else.")]
        [TestCase("true, when something, else it returns false.")]
        [TestCase("true, when something, false else.")]
        [TestCase("true: if something, else it returns false.")]
        [TestCase("true: if something, false: otherwise.")]
        [TestCase("true: if something,\r\n/// false: otherwise.")]
        [TestCase("true: when something, else it returns false.")]
        ...
        [TestCase("""<see langword="true"/> - When something; <see langword="false"/> otherwise.""")]
        [TestCase("""<see langword="true"/> - if something; <see langword="false"/> otherwise.""")]
        ...
        [TestCase("""<see langword="true"/> when something else false.""")]
        [TestCase("""<see langword="true"/> when something, <see langword="false"/> otherwise.""")]
        [TestCase("""<see langword="true"/> when something, otherwise <see langword="false"/>.""")]
        [TestCase("""<see langword="true"/> when something, otherwise returns <see langword="false"/>.""")]
        [TestCase("""<see langword="true"/> when something, returns otherwise <see langword="false"/>.""")]
        [TestCase("""<see langword="true"/> when something; <see langword="false"/> otherwise.""")]
        [TestCase("""<see langword="true"/> when something; otherwise <see langword="false"/>.""")]
        [TestCase("""<see langword="true"/>, if something; <see langword="false"/> otherwise.""")]
        [TestCase("""<see langword="true"/>, when something; <see langword="false"/> otherwise.""")]
        ...
        [TestCase("""Returns <see langref="true"/> when something, otherwise returns <see langref="false"/>.""")]
        [TestCase("""Returns <see langref="true"/> when something.""")]
        [TestCase("""Returns <see langword="true"/> if something.""")]
        [TestCase("""Returns <see langword="true"/> when something.""")]
