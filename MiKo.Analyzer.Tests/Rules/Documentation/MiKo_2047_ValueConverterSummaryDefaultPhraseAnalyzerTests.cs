...
{
    [TestFixture]
    public sealed class MiKo_2047_ValueConverterSummaryDefaultPhraseAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
");
        ...
        protected override string GetDiagnosticId() => MiKo_2047_ValueConverterSummaryDefaultPhraseAnalyzer.Id;
