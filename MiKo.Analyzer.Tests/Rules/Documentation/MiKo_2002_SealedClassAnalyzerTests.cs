...
{
    [TestFixture]
    public class MiKo_2002_SealedClassAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
");
        ...
        protected override string GetDiagnosticId() => MiKo_2002_SealedClassAnalyzer.Id;

        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_2002_SealedClassAnalyzer();
    }
}