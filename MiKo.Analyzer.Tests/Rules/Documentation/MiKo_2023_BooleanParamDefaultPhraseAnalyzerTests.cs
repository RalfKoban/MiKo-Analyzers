...
";
        ...
        [TestCase("Set to true if you want to do something", """<see langword="true"/> to do something; otherwise, <see langword="false"/>.""")]
        [TestCase("""Set to <see langword="true"/> if you need to do something, <see langword="false"/> otherwise.""", """<see langword="true"/> to do something; otherwise, <see langword="false"/>.""")]
        [TestCase("Set to true if you need to do something.", """<see langword="true"/> to do something; otherwise, <see langword="false"/>.""")]
