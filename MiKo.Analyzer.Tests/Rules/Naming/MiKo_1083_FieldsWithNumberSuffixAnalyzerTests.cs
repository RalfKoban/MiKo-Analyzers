...
");
        ...
        [Test]
        public void No_issue_is_reported_for_field_with_OS_bit_number_suffix_if_type_of_field_has_number_suffix_([Values(32, 64)] in int number) => No_issue_is_reported_for(@"
