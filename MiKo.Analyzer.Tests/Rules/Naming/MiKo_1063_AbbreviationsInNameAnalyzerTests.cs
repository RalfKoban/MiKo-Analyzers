...
namespace Bla
{
    public class TestMe
    {
        ...
        [TestCase("calc", "calculation", "calculate")]
        [TestCase("calc", "calculation", "calculating")]
        [TestCase("calc", "calculation", "calculation")]
        [TestCase("calc", "calculation", "calculations")]
        ...
        [TestCase("cycl", "cycle", "cycle")]
        [TestCase("cycl", "cycle", "cycles")]
        [TestCase("cycl", "cycle", "cycling")]
        [TestCase("cycl", "cycle", "bicycle")]
        [TestCase("Cycl", "Cycle", "Cycle")]
        [TestCase("Cycl", "Cycle", "Cycles")]
        [TestCase("Cycl", "Cycle", "Cycling")]
        ...
        [TestCase("indiv", "individual", "individual")]
        [TestCase("indiv", "individual", "individually")]
        [TestCase("indiv", "individual", "individuate")]
        [TestCase("indiv", "individual", "individuation")]
        [TestCase("indiv", "individual", "individuum")]
        [TestCase("indiv", "individual", "indivisible")]
        [TestCase("indiv", "individual", "indivisibility")]
        [TestCase("indiv", "individual", "indivisibly")]
        [TestCase("Indiv", "Individual", "Individual")]
        [TestCase("Indiv", "Individual", "Individually")]
        [TestCase("Indiv", "Individual", "Individuate")]
        [TestCase("Indiv", "Individual", "Individuation")]
        ...
        [TestCase("mem", "memory", "member")]
        [TestCase("mem", "memory", "memory")]
        [TestCase("mem", "memory", "remember")]
        [TestCase("Mem", "Memory", "Member")]
        [TestCase("Mem", "Memory", "Memory")]
        [TestCase("meth", "method", "method")]
        [TestCase("min", "minimum", "mini")]
        [TestCase("min", "minimum", "minimum")]
        [TestCase("mob", "mobile", "mobile")]
        [TestCase("mob", "mobile", "mobility")]
        [TestCase("mob", "mobile", "mobilities")]
        [TestCase("Mob", "Mobile", "Mobile")]
        [TestCase("Mob", "Mobile", "Mobility")]
        [TestCase("Mob", "Mobile", "Mobilities")]
        ...
        [TestCase("recalc", "recalculation", "recalculate")]
        [TestCase("recalc", "recalculation", "recalculating")]
        [TestCase("recalc", "recalculation", "recalculation")]
        [TestCase("recalc", "recalculation", "recalculations")]
        [TestCase("recalib", "recalibration", "recalibrate")]
        [TestCase("recalib", "recalibration", "recalibrating")]
        [TestCase("recalib", "recalibration", "recalibration")]
        [TestCase("recalib", "recalibration", "recalibrations")]
        ...
        [TestCase("scal", "scaling", "scale")]
        [TestCase("scal", "scaling", "scaling")]
        [TestCase("Scal", "Scaling", "Scale")]
        [TestCase("Scal", "Scaling", "Scaling")]
        [TestCase("sec", "security", "second")]
        [TestCase("sec", "security", "seconds")]
        [TestCase("sec", "security", "secure")]
        [TestCase("sec", "security", "security")]
        [TestCase("Sec", "Security", "Second")]
        [TestCase("Sec", "Security", "Seconds")]
        [TestCase("Sec", "Security", "Secure")]
        [TestCase("Sec", "Security", "Security")]
        ...
        [TestCase("veh", "vehicle", "vehicle")]
        [TestCase("Veh", "Vehicle", "Vehicle")]
        [TestCase("velo", "velocity", "velocity")]
        [TestCase("velo", "velocity", "velocities")]
        [TestCase("Velo", "Velocity", "Velocity")]
        [TestCase("Velo", "Velocity", "Velocities")]
