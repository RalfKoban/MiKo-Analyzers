...
");
        ...
        [Test]
        public void Fix_can_be_made([ValueSource(nameof(TestTearDowns))] string test) => VerifyCSharpFix(
        ...
        protected override CodeFixProvider GetCSharpCodeFixProvider() => new MiKo_1104_TestTeardownMethodsCodeFixProvider();
    }
}