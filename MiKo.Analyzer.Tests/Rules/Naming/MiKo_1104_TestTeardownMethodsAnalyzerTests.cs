...
");
        ...
        public void No_issue_is_reported_for_test_cleanup_method_with_correct_name(string testClassAttribute, string testAttribute) => No_issue_is_reported_for(@"
[" + testClassAttribute + @"]
public class TestMe
{
    [" + testAttribute + @"]
...
");
        ...
        [TestCase("TestClassAttribute", "TestCleanupAttribute")]
        [TestCase("TestClass", "TestCleanup")]
        public void An_issue_is_reported_for_test_cleanup_method_with_wrong_name(string testClassAttribute, string testAttribute) => An_issue_is_reported_for(@"
[" + testClassAttribute + @"]
public class TestMe
{
    [" + testAttribute + @"]
