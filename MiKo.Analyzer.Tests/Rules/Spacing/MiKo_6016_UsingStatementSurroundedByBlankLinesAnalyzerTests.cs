...
{
    [TestFixture]
    public sealed class MiKo_6016_UsingStatementSurroundedByBlankLinesAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
");
        ...
        [Test]
        public void An_issue_is_reported_for_using_blocks_as_statements_without_blank_line_between_both_blocks_in_method() => An_issue_is_reported_for(2, @"
namespace Bla
{
    public class TestMe
    {
...
";
        ...
        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_6016_UsingStatementSurroundedByBlankLinesAnalyzer();

        protected override string GetDiagnosticId() => MiKo_6016_UsingStatementSurroundedByBlankLinesAnalyzer.Id;

        protected override CodeFixProvider GetCSharpCodeFixProvider() => new MiKo_6016_CodeFixProvider();
    }
}