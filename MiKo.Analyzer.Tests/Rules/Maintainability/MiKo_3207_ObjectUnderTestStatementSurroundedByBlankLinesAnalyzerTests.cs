...
{
    [TestFixture]
    public sealed class MiKo_3207_ObjectUnderTestStatementSurroundedByBlankLinesAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
";
        ...
        protected override string GetDiagnosticId() => MiKo_3207_ObjectUnderTestStatementSurroundedByBlankLinesAnalyzer.Id;

        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_3207_ObjectUnderTestStatementSurroundedByBlankLinesAnalyzer();

        protected override CodeFixProvider GetCSharpCodeFixProvider() => new MiKo_3207_CodeFixProvider();
    }
}