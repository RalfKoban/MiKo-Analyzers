...
{
    [TestFixture]
    public sealed class MiKo_3209_TryStatementSurroundedByBlankLinesAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
";
        ...
        protected override string GetDiagnosticId() => MiKo_3209_TryStatementSurroundedByBlankLinesAnalyzer.Id;

        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_3209_TryStatementSurroundedByBlankLinesAnalyzer();

        protected override CodeFixProvider GetCSharpCodeFixProvider() => new MiKo_3209_CodeFixProvider();
    }
}