...
{
    [TestFixture]
    public class MiKo_3214_WhileStatementSurroundedByBlankLinesAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
namespace Bla
{
    public class TestMe
    {
        ...
        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_3214_WhileStatementSurroundedByBlankLinesAnalyzer();

        protected override string GetDiagnosticId() => MiKo_3214_WhileStatementSurroundedByBlankLinesAnalyzer.Id;

        protected override CodeFixProvider GetCSharpCodeFixProvider() => new MiKo_3214_CodeFixProvider();
    }
}