...
public class TestMe
{
    public void DoSomething(object o)
    {
        ...
        [Test]
        public void No_issue_is_reported_for_negative_type_check_with_property_matching_as_if_condition() => No_issue_is_reported_for(@"
using System;
...
public class TestMe
{
    public void DoSomething(object o)
    {
        if (o is not ISomeInterface { SomeValue: true })
        {
        }
    }
}");
