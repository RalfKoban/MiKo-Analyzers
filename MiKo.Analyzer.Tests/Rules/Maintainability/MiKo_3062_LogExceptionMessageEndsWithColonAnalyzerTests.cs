...
{
    [TestFixture]
    public sealed class MiKo_3062_LogExceptionMessageEndsWithColonAnalyzerTests : CodeFixVerifier
    {
...
");
        ...
        protected override string GetDiagnosticId() => MiKo_3062_LogExceptionMessageEndsWithColonAnalyzer.Id;

        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_3062_LogExceptionMessageEndsWithColonAnalyzer();
    }
}