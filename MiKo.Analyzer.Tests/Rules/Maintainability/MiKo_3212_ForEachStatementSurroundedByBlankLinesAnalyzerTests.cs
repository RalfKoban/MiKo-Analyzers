...
{
    [TestFixture]
    public class MiKo_3212_ForEachStatementSurroundedByBlankLinesAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
namespace Bla
{
    public class TestMe
    {
        ...
        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_3212_ForEachStatementSurroundedByBlankLinesAnalyzer();

        protected override string GetDiagnosticId() => MiKo_3212_ForEachStatementSurroundedByBlankLinesAnalyzer.Id;

        protected override CodeFixProvider GetCSharpCodeFixProvider() => new MiKo_3212_CodeFixProvider();
    }
}