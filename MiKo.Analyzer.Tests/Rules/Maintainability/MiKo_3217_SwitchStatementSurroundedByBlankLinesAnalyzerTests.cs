...
{
    [TestFixture]
    public class MiKo_3217_SwitchStatementSurroundedByBlankLinesAnalyzerTests : CodeFixVerifier
    {
        [Test]
...
";
        ...
        protected override DiagnosticAnalyzer GetObjectUnderTest() => new MiKo_3217_SwitchStatementSurroundedByBlankLinesAnalyzer();

        protected override string GetDiagnosticId() => MiKo_3217_SwitchStatementSurroundedByBlankLinesAnalyzer.Id;
