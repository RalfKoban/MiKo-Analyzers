...
namespace MiKoSolutions.Analyzers.Linguistics
{
    ...
    public static class VerbalizerTests
    {
        ...
        [TestCase("Validation", ExpectedResult = "Validate")]
        [TestCase("validation", ExpectedResult = "validate")]
        ...
        [TestCase("handling", ExpectedResult = "handle")]
        ...
        [TestCase("Estimation", ExpectedResult = "Estimates")]
        [TestCase("estimation", ExpectedResult = "estimates")]
        [TestCase("extend", ExpectedResult = "extends")]
        [TestCase("extending", ExpectedResult = "extends")]
        [TestCase("extension", ExpectedResult = "extends")]
        [TestCase("Extension", ExpectedResult = "Extends")]
        [TestCase("frozen", ExpectedResult = "freezes")]
        [TestCase("handle", ExpectedResult = "handles")]
        [TestCase("handled", ExpectedResult = "handles")]
        [TestCase("handling", ExpectedResult = "handles")]
        ...
        [TestCase("implement", ExpectedResult = "implements")]
        [TestCase("implementation", ExpectedResult = "implements")]
        [TestCase("Implementation", ExpectedResult = "Implements")]
        [TestCase("implementing", ExpectedResult = "implements")]
        ...
        [TestCase("operate", ExpectedResult = "operates")]
        [TestCase("operating", ExpectedResult = "operates")]
        [TestCase("operation", ExpectedResult = "operates")]
        [TestCase("pinging", ExpectedResult = "pings")]
        [TestCase("pop", ExpectedResult = "pops")]
        [TestCase("pops", ExpectedResult = "pops")]
        [TestCase("recommend", ExpectedResult = "recommends")]
        [TestCase("recommending", ExpectedResult = "recommends")]
        [TestCase("recommendation", ExpectedResult = "recommends")]
        ...
        [TestCase("Triggered", ExpectedResult = "Triggers")]
        [TestCase("validate", ExpectedResult = "validates")]
        [TestCase("validating", ExpectedResult = "validates")]
        [TestCase("validation", ExpectedResult = "validates")]
        [TestCase("Validation", ExpectedResult = "Validates")]
