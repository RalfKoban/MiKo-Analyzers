...
namespace MiKoSolutions.Analyzers.Linguistics
{
    ...
    public static class AbbreviationFinderTests
    {
        ...
        [Test]
        public static void Finds_postfix_abbreviation_in_([ValueSource(nameof(Postfixes))] in Pair postfix)
        {
        ...
        [Test]
        public static void Finds_prefix_abbreviations_and_fixes_them_in_([ValueSource(nameof(Prefixes))] in Pair prefix)
        {
        ...
        [Test]
        public static void Finds_upper_case_prefix_abbreviations_and_fixes_them_in_([ValueSource(nameof(UpperCasePrefixes))] in Pair prefix)
        {
            var replacement = AbbreviationFinder.FindAndReplaceAllAbbreviations(prefix.Key + "SomeName");
        ...
        [Test]
        public static void Finds_midterm_abbreviations_and_fixes_them_in_([ValueSource(nameof(MidTerms))] in Pair midterm)
        {
        ...
        [Test]
        public static void Finds_postfix_abbreviations_and_fixes_them_in_([ValueSource(nameof(Postfixes))] in Pair postfix)
        {
