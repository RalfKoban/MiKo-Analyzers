...
namespace MiKoSolutions.Analyzers.Linguistics
{
    ...
    public sealed class AbbreviationDetectorTests
    {
        ...
        public string Finds_prefix_abbreviations_and_fixes_them_in_(string value)
        {
            var findings = AbbreviationDetector.Find(value);

            return AbbreviationDetector.ReplaceAllAbbreviations(value, findings);
        }
        ...
        [TestCase("someNameVm", ExpectedResult = "someNameViewModel")]
        public string Finds_postfix_abbreviations_and_fixes_them_in_(string value)
        {
            var findings = AbbreviationDetector.Find(value);
