...
[![Maintenance](https://img.shields.io/maintenance/yes/2022.svg)](https://github.com/RalfKoban/MiKo-Analyzers)
...
## Available Rules
The following tables list all the 314 rules that are currently provided by the analyzer.
...
|MiKo_3017|Do not swallow thrown exceptions when throwing exceptions.|&#x2713;|\-|
