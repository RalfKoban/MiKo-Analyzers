...
[![Test status](http://teststatusbadge.azurewebsites.net/api/status/RalfKoban/miko-analyzers/branch/master)]
...
|MiKo_1039|Extension methods 'this' parameter should have default name.|&#x2713;|
